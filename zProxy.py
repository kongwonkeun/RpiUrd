...
if  __name__ == '__main__':
    ...
    #client = zPipe.PipeClient(pipe=zPipe.PIPE_FOOBAR, show=zPipe.SHOW_OFF, callback=proxy.send_message_to_all)
    client = zPipe.PipeClient(pipe=zPipe.PIPE_FOOBAR, callback=proxy.send_message_to_all)
    proxy.run_server()
    client.quit()
